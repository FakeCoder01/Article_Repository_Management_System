...
if (isset($_POST["query"])) {
  ...
  $query = "SELECT DISTINCT * FROM `posts` WHERE `posts`.`title` LIKE '%$search%' 
            UNION
            SELECT DISTINCT * FROM `posts` WHERE `posts`.`content` LIKE '%$search%'
            UNION
            SELECT DISTINCT * FROM `posts` WHERE `posts`.`username` LIKE '%$search%'
            UNION
            SELECT DISTINCT * FROM `posts` WHERE `posts`.`id` LIKE '%$search%'
            ORDER BY `title` ; 
            ";
